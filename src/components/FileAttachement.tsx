...
export const FileAttachement: React.FC<DownloadButtonProps> = ({
  pdfUrl = ".\\src\\assets\\CV\\Alexandre Goumain-9.pdf",
  pdfName = "CvAlexandreGoumain.pdf",
}) => {
    ...
    <>
      <div className="flex items-start gap-2.5">
        <div className="flex flex-col gap-1">
          {/* BULLE CONTENANT LE PDF ET SON TELECHARGEMENT */}
          <div className="flex items-start my-2.5 bg-gray-600 rounded-xl p-2">
            <div className="me-2">
              ...
              <span className="flex text-xs font-normal text-gray-400 gap-2 px-4">
                1 Page
                <svg
            ...
            <div className="inline-flex self-center items-center">
              ...
              <button
                className="inline-flex self-center items-center p-2 text-sm font-medium text-center rounded-lg focus:ring-4 focus:outline-none text-white bg-gray-600 hover:bg-gray-500 focus:ring-gray-600 duration-150"
                type="button"
